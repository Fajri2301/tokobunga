...
@section('title', 'Hubungi Kami - ' . ($global_setting->site_name ?? 'Zanki Dausat Flower'))
...
<div class="pt-28 sm:pt-32 md:pt-48 pb-24">
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 md:px-8 mb-10 sm:mb-16 text-center reveal" data-reveal-delay="0">
        <p class="text-white/60 text-xs font-bold uppercase tracking-[0.3em] mb-3">Kami Ada Untuk Anda</p>
    ...
    <div class="max-w-7xl mx-auto px-4 sm:px-6 md:px-8">
        <div class="bg-white rounded-3xl sm:rounded-[40px] shadow-2xl overflow-hidden flex flex-col lg:flex-row items-stretch lg:min-h-[600px]">
            <!-- Info Side -->
            <div class="w-full lg:w-[400px] bg-[#0D2137] p-6 sm:p-10 md:p-16 text-white flex flex-col justify-between relative">
                <!-- Decoration -->
                <div class="absolute top-0 right-0 w-32 h-32 bg-white/5 rounded-bl-full"></div>
                
                <div class="relative z-10 flex flex-col gap-8 sm:gap-12">
                    <div>
                        <h2 class="text-2xl sm:text-3xl font-black uppercase tracking-tight mb-6 sm:mb-8">Info Kontak</h2>
                        <div class="flex flex-col gap-8">
                            <div class="flex items-start gap-5">
                                <div class="w-12 h-12 shrink-0 rounded-2xl bg-white/10 flex items-center justify-center text-[#F4799A] shadow-inner">
                ...
                <div class="relative z-10 pt-8 sm:pt-12 border-t border-white/10 mt-8 sm:mt-12 flex gap-4">
                    <!-- Social Links -->
                    @if($global_setting->instagram_url)
                    <a href="{{ $global_setting->instagram_url }}" class="w-10 h-10 rounded-xl bg-white/5 flex items-center justify-center hover:bg-[#0cc0df] transition-all">
            ...
            <!-- Map Side -->
            <div class="flex-1 min-h-[300px] sm:min-h-[400px] relative">
