...
<div class="grid grid-cols-1 md:grid-cols-4 gap-6">
    ...
    <div class="bg-white p-8 rounded-[32px] shadow-sm border border-slate-100 flex items-center group hover:shadow-xl transition-all duration-500">
        <div class="h-14 w-14 rounded-2xl bg-[#0cc0df]/10 text-[#0cc0df] flex items-center justify-center mr-5 group-hover:scale-110 transition-transform">
...
<div class="grid grid-cols-1 lg:grid-cols-2 gap-8 mt-8">
    ...
    <div class="bg-white rounded-[40px] shadow-sm border border-slate-100 overflow-hidden">
        <div class="p-8 border-b border-slate-50 flex justify-between items-center">
            ...
            <a href="{{ route('admin.orders.index') }}" class="text-[10px] font-black text-[#0cc0df] uppercase tracking-widest hover:text-[#545454] transition-colors">Lihat Semua</a>
        </div>
            ...
            <table class="w-full text-left">
                ...
                <tbody class="divide-y divide-slate-50">
                    ...
                    <tr class="text-sm text-slate-600 hover:bg-slate-50 transition-colors">
                        <td class="px-8 py-5 font-black text-[#0cc0df]">#{{ $order->order_number }}</td>
...
<div class="mt-8 bg-[#545454] rounded-[40px] p-10 border border-white/10 shadow-2xl relative overflow-hidden group">
    ...
    <div class="relative z-10 flex flex-col md:flex-row items-center justify-between gap-8">
        ...
        <div class="flex flex-wrap justify-center gap-4">
            <a href="{{ route('admin.products.create') }}" class="px-8 py-4 bg-[#0cc0df] text-white rounded-full font-black text-[10px] uppercase tracking-[0.2em] shadow-lg shadow-[#0cc0df]/20 hover:bg-white hover:text-[#545454] transition-all">
                Tambah Produk Baru
            </a>
